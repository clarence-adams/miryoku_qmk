...
U_NP, KC_Q, KC_W, KC_E,   KC_R,    KC_T,   KC_Y,    KC_U,    KC_I,    KC_O,     KC_P,   \
KC_LSHFT, KC_A, KC_S, KC_D,   KC_F,    KC_G,   KC_H,    KC_J,    KC_K,    KC_L,     KC_QUOT,\
U_NP, KC_Z, KC_X, KC_C,   KC_V,    KC_B,   KC_N,    KC_M,    KC_COMM, KC_DOT,   KC_SLSH,\
U_NP, U_NP, KC_ESC, KC_SPC,  KC_TAB, KC_ENT,  KC_BSPC, LT(U_FUN,KC_DEL),  U_NP, U_NP
